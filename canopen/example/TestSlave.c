...
/* index 0x1800 :   Transmit PDO 1 Parameter. */
                    ...
                    UNS8 TestSlave_obj1800_Transmission_Type = 0;	/* 0 */
...
/* index 0x1801 :   Transmit PDO 2 Parameter. */
                    ...
                    UNS32 TestSlave_obj1801_COB_ID_used_by_PDO = 255;	/* 640 */
...
/* index 0x1803 :   Transmit PDO 4 Parameter. */
                    ...
                    UNS8 TestSlave_obj1803_Transmission_Type = 252;	/* 252 */
                    UNS16 TestSlave_obj1803_Inhibit_Time = 0;	/* 0 */
                    UNS8 TestSlave_obj1803_Compatibility_Entry = 0x0;	/* 0 */
                    UNS16 TestSlave_obj1803_Event_Timer = 0;	/* 0 */
...
/* index 0x1804 :   Transmit PDO 5 Parameter. */
                    ...
                    UNS8 TestSlave_obj1804_Transmission_Type = 253;	/* 253 */
                    ...
                    subindex TestSlave_Index1F50[] = 
                     {
                       ...
                       { RW, domain, 889, (void*)TestSlave_obj1F50 }
                     };

/* index 0x1F51 :   Program Control. */
                    UNS8 TestSlave_highestSubIndex_obj1F51 = 1; /* number of subindex - 1*/
                    UNS8 TestSlave_obj1F51[] = 
                    {
                      0x0	/* 0 */
                    };
										ODCallback_t TestSlave_Index1F51_callbacks[] = 
                     {
                       NULL,
                       NULL,
                     };
                    subindex TestSlave_Index1F51[] = 
                     {
                       { RO, uint8, sizeof (UNS8), (void*)&TestSlave_highestSubIndex_obj1F51 },
                       { RW, uint8, sizeof (UNS8), (void*)&TestSlave_obj1F51[0] }
                     };

/* index 0x1F52 :   Verify Application Software. */
                    UNS8 TestSlave_highestSubIndex_obj1F52 = 2; /* number of subindex - 1*/
                    UNS32 TestSlave_obj1F52_Application_software_date = 0x0;	/* 0 */
                    UNS32 TestSlave_obj1F52_Application_sofware_time = 0x0;	/* 0 */
                    subindex TestSlave_Index1F52[] = 
                     {
                       { RO, uint8, sizeof (UNS8), (void*)&TestSlave_highestSubIndex_obj1F52 },
                       { RW, uint32, sizeof (UNS32), (void*)&TestSlave_obj1F52_Application_software_date },
                       { RW, uint32, sizeof (UNS32), (void*)&TestSlave_obj1F52_Application_sofware_time }
                     };
...
const indextable TestSlave_objdict[] = 
{
  ...
  { (subindex*)TestSlave_Index1A04,sizeof(TestSlave_Index1A04)/sizeof(TestSlave_Index1A04[0]), 0x1A04},
	...
	{ (subindex*)TestSlave_Index1F51,sizeof(TestSlave_Index1F51)/sizeof(TestSlave_Index1F51[0]), 0x1F51},
	{ (subindex*)TestSlave_Index1F52,sizeof(TestSlave_Index1F52)/sizeof(TestSlave_Index1F52[0]), 0x1F52},
...
const indextable * TestSlave_scanIndexOD (CO_Data *d, UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x2005: i = 29;break;
		case 0x2006: i = 30;break;
		case 0x2007: i = 31;break;
		case 0x2008: i = 32;break;
		case 0x2009: i = 33;break;
		case 0x200A: i = 34;break;
		case 0x200B: i = 35;break;
		case 0x200C: i = 36;break;
		default:
